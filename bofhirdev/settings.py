"""
Django settings for bofhirdev project.
...
from bofhirdev.utils import str2bool, str2int
...
if APPLICATION_TITLE == "":
    APPLICATION_TITLE = "BB+ Developer"
...
# Override the default OAuth2 Application model to add extra fields.
...
OAUTH2_PROVIDER = {
    'SCOPES': {
        'read': 'Read scope',
        'write': 'Write scope',
        'privacy_write': "Update your privacy choices",
    },
...
ROOT_URLCONF = 'bofhirdev.urls'

# Moved wsgi.py to apache2 sub-directory for better security protection
WSGI_APPLICATION = 'bofhirdev.apache2.wsgi.application'
...
if DB_PLATFORM == "postgresql_psycopg2":
    ...
    DATABASES = {
        'default' : {
            ...
            'NAME' : 'bofhirdev',  # Or path to database file if using sqlite3.
...
# Format options: 'E164', 'INTERNATIONAL' or 'RFC3966'. 'NATIONAL'
PHONE_NUMBER_DB_FORMAT = 'NATIONAL'
# NATIONAL requires PHONENUMBER_DEFAULT_REGION to be set
...
# SHOW_TOOLBAR_CALLBACK = 'bofhirdev.debug'
...
# try:
#     from bofhirdev.local_settings import *
